...
export default function BusinessTourBlock({
  ...
  return (
    <div className="relative overflow-hidden rounded-[1.75rem] border border-gold-300/20 bg-gradient-to-br from-ink-900 via-ink-900 to-ink-800 p-7 sm:rounded-[2rem] sm:p-12">
      ...
      <div className="pointer-events-none absolute -bottom-32 -left-32 h-72 w-72 rounded-full bg-aqua-400/15 blur-[100px] sm:h-96 sm:w-96" />

      <motion.div {...fade} className="relative">
        <div className="eyebrow mb-3 sm:mb-4">Бизнес-тур в Дубае</div>
        <h3 className="font-serif text-2xl text-body sm:text-4xl lg:text-5xl">
          3 дня офлайн в Дубае,{" "}
          <span className="gold-text">месяц онлайн</span>
        </h3>

        <div className="mt-5 flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-body-muted sm:mt-6 sm:gap-x-8 sm:gap-y-3 sm:text-base">
