                ...
                <>
                  ...
                  {images.length > 1 && (
                    <>
                      ...
                      <div className="absolute bottom-3 left-1/2 z-10 -translate-x-1/2 rounded-full border border-white/15 bg-ink-950/80 px-3 py-1 text-xs text-body-muted backdrop-blur sm:bottom-5">
            ...
            <div className="border-t border-ink-700 p-6 sm:p-8">
              <div className="flex flex-wrap items-baseline justify-between gap-3">
                ...
                {project.year_founded && (
                  <span className="rounded-full border border-white/10 px-2.5 py-0.5 text-[10px] uppercase tracking-wider text-body-muted">
                    {project.year_founded}
                  </span>
                )}
              </div>
              ...
              {project.description && (
                <p className="mt-3 text-sm text-body-muted sm:text-[15px]">
                  {project.description}
                </p>
              )}

              <div className="mt-5 flex flex-wrap items-center gap-x-5 gap-y-2 text-xs text-body-muted sm:text-sm">
                {project.location && (
