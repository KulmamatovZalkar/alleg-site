          ...
          <div className="container-page">
            <div className="grid items-start gap-8 sm:gap-10 lg:grid-cols-2">
              <div>
                ...
                />
                <div className="mt-6 space-y-3 text-sm text-body-muted sm:mt-8 sm:text-base">
                  {settings.contact_email && (
                    <div>
                      <span className="text-body-muted">Email:</span>{" "}
                      <a className="hover:text-gold-600" href={`mailto:${settings.contact_email}`}>
                        {settings.contact_email}
                      </a>
                    </div>
                  )}
                  {settings.whatsapp_link && (
                    <div>
                      ...
                      <a className="hover:text-gold-600" href={settings.whatsapp_link} target="_blank" rel="noreferrer">
                        Написать в WhatsApp
                      </a>
                    </div>
                  )}
                  {settings.telegram_username && (
                    <div>
                      <span className="text-body-muted">Telegram:</span>{" "}
                      <a className="hover:text-gold-600" href={`https://t.me/${settings.telegram_username}`} target="_blank" rel="noreferrer">
                        @{settings.telegram_username}
                      </a>
                    </div>
                  )}
