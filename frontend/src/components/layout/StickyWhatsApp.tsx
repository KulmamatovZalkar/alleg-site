  ...
  return (
    <div className="fixed bottom-4 right-4 z-40 flex items-center gap-2 sm:bottom-8 sm:right-8 sm:gap-3">
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className={`hidden whitespace-nowrap rounded-full border border-gold-300/40 bg-ink-950/85 px-4 py-2 text-xs text-gold-100 shadow-lg backdrop-blur-md transition-all duration-500 sm:inline-flex sm:text-sm ${
          showHint
            ? "translate-x-0 opacity-100"
            : "pointer-events-none translate-x-4 opacity-0"
        } sm:hover:border-gold-300/70 sm:hover:bg-ink-900`}
      >
