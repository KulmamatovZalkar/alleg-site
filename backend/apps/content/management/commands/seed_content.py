...
class Command(BaseCommand):
    ...
    def _seed_settings(self):
        ...
        s.hero_title = (
            "Аллег Ким. "
            "Ресторатор и бизнес-тренер для ресторанного бизнеса."
        )
        s.hero_subtitle = (
            "Действующий ресторатор и сертифицированный тренер STI Dubai. "
            "Основатель холдинга «Ассорти Проджект»."
        )
        s.hero_description = (
            "25 лет в ресторанном бизнесе. 8 ресторанов в двух брендах — Koreana и Alchik. "
            "Учу собственников строить ресторанный бизнес как систему, а не на интуиции."
        )
        s.hero_primary_cta = "Записаться на консультацию"
        s.hero_secondary_cta = "Программа бизнес-тура"

        s.about_title = "Аллег Ким"
        s.about_subtitle = "Ресторатор. Бизнес-тренер ресторанного бизнеса."
        s.about_text = (
            "<p>25 лет в ресторанном бизнесе. Основатель холдинга "
            "<strong>«Ассорти Проджект»</strong> — 8 ресторанов в двух брендах "
            "(<strong>Koreana</strong> и <strong>Alchik</strong>).</p>"
            "<p>Сертифицированный <strong>тренер STI Dubai</strong> "
            "(Syucai Training Institute LLC). Обучаю собственников ресторанов и кафе "
            "выстраивать управляемый, прибыльный бизнес.</p>"
            "<p>Работаю не на теории, а на собственном практическом опыте "
            "ресторатора — и передаю его как тренер.</p>"
        )
        ...
        s.seo_title = (
            "Аллег Ким — Ресторатор и бизнес-тренер. Консалтинг и бизнес-тур в Дубае"
        )
        s.seo_description = (
            "Развитие ресторанного бизнеса: системный подход, управленческий учёт, "
            "масштабирование. Действующий ресторатор, основатель холдинга «Ассорти Проджект» "
            "(Koreana, Alchik). Сертифицированный тренер STI Dubai."
        )
        s.save()
    ...
    def _seed_achievements(self):
        data = [
            dict(title="25", subtitle="лет в ресторанном бизнесе",
            ...
            dict(title="1000+", subtitle="бизнес-консультаций для рестораторов",
                 icon="briefcase", size="medium", accent=False, order=30),
            dict(title="STI Dubai", subtitle="сертифицированный тренер",
                 icon="graduation", size="medium", accent=False, order=40),
            dict(title="2 бренда", subtitle="Koreana и Alchik под управлением",
